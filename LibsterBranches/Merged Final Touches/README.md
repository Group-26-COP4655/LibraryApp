...
- [X] User can navigate to the profile screen using the navigation bar to see the logout button
- [X] User can navigate to the selection screen using the navigation bar to see the selection of books
- [X] User can scroll through the top 20 books that are displayed by default
...
- [X] User taps on a continue reading to keep reading from the page where they made the bookmark
...
- [X] User can remove the bookmark and gets taken back to the bookmarks page
- [X] User taps the save button to borrow the book
- [X] User sees their username at the top of the profile page
- [X] User can return a borrowed book
- [X] User can delete account and has to confirm deletion
